    ...
    <div id="services" className="w-full">
      ...
      >
        ...
        <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden bg-transparent">
          ...
          {/* ── Cards Interactive Stacking Deck Layer (Strictly equal 20.5vh steps between all 4 cards) ── */}
          <div className="relative w-full max-w-[964px] 2xl:max-w-[1300px] min-[1920px]:max-w-[1500px] h-screen flex items-center justify-center pointer-events-auto">
            {/* ── Card 1: Pinned to Left-0, Top-[3vh], z-10 ── */}
            <motion.div
              style={{
                y: card1Y,
                zIndex: 10,
              ...
              className="absolute left-0 top-[3vh] w-[500px] 2xl:w-[680px] min-[1920px]:w-[780px] max-w-[85vw] h-[clamp(260px,28vh,400px)] flex flex-col justify-between items-start rounded-none shadow-none"
            >
            ...
            {/* ── Card 2: Left-aligned, Top-[23.5vh], z-20 (White Card) ── */}
            <motion.div
              style={{
                y: card2Y,
                zIndex: 20,
              ...
              className="absolute left-[40px] 2xl:left-[100px] min-[1920px]:left-[140px] top-[23.5vh] w-[480px] 2xl:w-[640px] min-[1920px]:w-[740px] max-w-[85vw] h-[clamp(260px,28vh,400px)] flex flex-col justify-between items-start rounded-none shadow-none"
            >
              <div className="font-mono text-[13px] 2xl:text-[16px] min-[1920px]:text-[17px] font-bold leading-[125%] tracking-[-0.14px] lowercase whitespace-pre-line">
            ...
            <motion.div
              ...
              className="absolute right-[30px] 2xl:right-[80px] min-[1920px]:right-[120px] top-[44vh] w-[500px] 2xl:w-[680px] min-[1920px]:w-[780px] max-w-[85vw] h-[clamp(260px,28vh,400px)] flex flex-col justify-between items-start rounded-none shadow-none"
            >
              <div className="font-mono text-[13px] 2xl:text-[16px] min-[1920px]:text-[17px] font-bold leading-[125%] tracking-[-0.14px] lowercase whitespace-pre-line">
            ...
            {/* ── Card 4: Right-0, Top-[64.5vh], z-40 — Strictly Equal Step ── */}
            <motion.div
              style={{
                y: card4Y,
                zIndex: 40,
              ...
              className="absolute right-0 top-[64.5vh] w-[540px] 2xl:w-[740px] min-[1920px]:w-[840px] max-w-[92vw] h-[clamp(260px,28vh,400px)] flex flex-col justify-between items-start rounded-none shadow-none"
            >
              <div className="font-mono text-[13px] 2xl:text-[16px] min-[1920px]:text-[17px] font-bold leading-[125%] tracking-[-0.14px] lowercase whitespace-pre-line">
